...
const Principal = ({ irAPagina }) => {
      ...
      <div className="section-hero">
        ...
        <div className="content">
          ...
          <div className="btn-container">
            <Button variant="outline-light" style={{ width: "30%" }} onClick={() => irAPagina("About")}>
              Sobre Mi
            </Button>
          </div>
        </div>
  ...
  />
      ...
      <div className="section section-1">
        <div className="left" onClick={() => irAPagina("Cooperativa")}>
        ...
        <div className="right" onClick={() => irAPagina("LinkinTool")}>
      ...
      <div className="section section-3">
        <div className="left"          onClick={handleShow}
...
<Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>  Este proyecto se encuentra en desarrollo y muy pronto estará disponible.
</Modal.Body>
        <Modal.Footer>
